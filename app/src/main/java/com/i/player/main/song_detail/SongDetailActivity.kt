...
import com.i.player.databinding.ActivitySongDetailBinding
...
class SongDetailActivity : BaseActivity<ActivitySongDetailBinding, SongDetailViewModel>() {
    ...
    private fun handleExtras() {
        val extras = intent
        val songList = extras?.getParcelableArrayListExtra<SongModel>(EXTRA_SONG_LIST) as List<SongModel>?
        val songEntity = extras?.getParcelableExtra(EXTRA_SONG) as SongModel?
